...
- **Breaking change:** Use Metro binding containers for presenter providers and KSP-generated bindings; custom empty `RobotGraph`s must include `RobotGraph.Bindings`. Recompile consumers.
