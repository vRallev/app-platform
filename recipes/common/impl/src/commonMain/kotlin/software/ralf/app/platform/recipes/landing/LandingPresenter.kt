...
import software.ralf.app.platform.recipes.navigation.LoginPresenter
...
class LandingPresenter : ComposePresenter<Unit, Model> {
  ...
  override fun present(input: Unit): Model {
    ...
    return Model {
      when (it) {
        ...
        Event.PresenterNavigation -> {
          backstack.push(LoginPresenter())
        }
      }
    }
  }
  ...
  sealed interface Event {
    ...
    /** Show the recipe highlighting navigation between child presenters. */
    data object PresenterNavigation : Event
  }
}
