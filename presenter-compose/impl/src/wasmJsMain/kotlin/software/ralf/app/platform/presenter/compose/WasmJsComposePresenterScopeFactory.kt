 ...
 * as fast as possible.
 */
public class WasmJsComposePresenterScopeFactory(coroutineScopeFactory: () -> CoroutineScope) :
  ComposePresenterScopeFactory by DefaultComposePresenterScopeFactory(
    coroutineScopeFactory = coroutineScopeFactory,
    recompositionMode = RecompositionMode.Immediate,
  )

/** Provides the [WasmJsComposePresenterScopeFactory] in the kotlin-inject graph. */
@KiContributesTo(KiAppScope::class)
public interface WasmJsComposePresenterScopeFactoryComponent {
  /**
   * Provides the [WasmJsComposePresenterScopeFactory] in the kotlin-inject graph as a singleton.
   */
  @KiProvides
