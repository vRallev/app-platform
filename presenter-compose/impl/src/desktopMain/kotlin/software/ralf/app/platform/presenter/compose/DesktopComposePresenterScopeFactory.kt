 ...
 * as fast as possible.
 */
public class DesktopComposePresenterScopeFactory(coroutineScopeFactory: () -> CoroutineScope) :
  ComposePresenterScopeFactory by DefaultComposePresenterScopeFactory(
    coroutineScopeFactory = coroutineScopeFactory,
    recompositionMode = RecompositionMode.Immediate,
  )

/** Provides the [DesktopComposePresenterScopeFactory] in the kotlin-inject graph. */
@KiContributesTo(KiAppScope::class)
public interface DesktopComposePresenterScopeFactoryComponent {
  /**
   * Provides the [DesktopComposePresenterScopeFactory] in the kotlin-inject graph as a singleton.
   */
  @KiProvides
