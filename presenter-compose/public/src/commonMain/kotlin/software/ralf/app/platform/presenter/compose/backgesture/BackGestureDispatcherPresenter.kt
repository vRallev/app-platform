...
public interface BackGestureDispatcherPresenter {
   ...
   * [software.ralf.app.platform.presenter.compose.backgesture.PredictiveBackHandlerPresenter] for
   * more details.
   */
  @Composable
...
@Composable
public fun ComposePresenter<*, *>.PredictiveBackHandlerPresenter(
...
// presenter. This will make sure that a renderer doesn't call this function accidentally.
@Composable
public fun ComposePresenter<*, *>.BackHandlerPresenter(
  enabled: Boolean = true,
  onBack: () -> Unit,
) {
