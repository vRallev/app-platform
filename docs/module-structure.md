...
* An [Android namespace](https://developer.android.com/build/configure-app-module#set-namespace) is set [automatically](https://github.com/vRallev/app-platform/blob/main/gradle-plugin/plugin/src/main/kotlin/software/ralf/app/platform/gradle/ModuleStructurePlugin.kt#L90-L110) if it hasn't been configured yet.
