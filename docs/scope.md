...
The wait is cancellable. If the caller is canceled, the scope stays destroyed and coroutine cleanup
continues. Call `destroyAndWait()` again to resume waiting for the same cleanup.
